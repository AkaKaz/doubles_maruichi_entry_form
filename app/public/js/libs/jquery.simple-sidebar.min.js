  ...
  (a.fn.simpleSidebar = function (b) {
    ...
    return this.each(function () {
      ...
      -1 !== [void 0, "right"].indexOf(c.sidebar.align)
        ...
        !0 === c.mask.display && H.appendTo("body").css(h),
        (i = s > t ? t - r : q),
        (e = { position: "fixed", top: 0, bottom: 0, width: i }),
        (x[b] = 0),
        (e[b] = -i),
        (f = a.extend(!0, e, c.sidebar.css)),
        k.css(f).attr("data-" + j, "disabled"),
        !0 === c.sbWrapper.display && k.wrapInner(G),
        l.click(function () {
          var a = k.attr("data-" + j),
            c = k.width();
          (v[b] = "+=" + c),
        ...
        a(window).resize(function () {
          ...
          (c = s > f ? f - r : q),
            ...
            (g[d] = ""),
            (g.width = c),
            k.css(g).attr("data-" + j, "disabled"),
            "active" === e && (J.not(k).animate(w, C), H.fadeOut(u));
        });
    });
  }),
