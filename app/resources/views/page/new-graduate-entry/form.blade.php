...
@section('main-area')
    ...
    <form name="form" method="post" id="form" action="{{ route('new-graduate.confirm') }}"
        ...
        <div class="form-box clearfix">
            ...
            <x-new-graduate-entry.profile-form />
        </div>
        ...
        <div class="form-box clearfix">
            ...
            <x-new-graduate-entry.address-form name="address">
                <x-slot:foot>
                    <tr>
                        <th>携帯電話</th>
        ...
        <div id="home-form" class="form-box clearfix {{ old('home.same_addr') ? 'hide-address-form' : '' }}">
            ...
            <x-new-graduate-entry.address-form name="home">
                <x-slot:head>
                    <tr>
            ...
            <x-new-graduate-entry.resume-form count="7" name="educationals">
                <x-slot:head>
                    <tr>
                        <td colspan="2" class="form-input-check">
                            <div>
                                学歴については高等学校卒業より記入する事
                            </div>
                        </td>
                    </tr>
                </x-slot>
            </x-new-graduate-entry.resume-form>
        </div>

        <div class="form-box clearfix">
            <h3>免許・資格</h3>
            <x-new-graduate-entry.resume-form count="5" name="licenses" />
        </div>

        <div class="form-box clearfix">
            <h3>賞罰</h3>
            <x-new-graduate-entry.resume-form count="4" name="rewards" />
        </div>
        ...
        <div class="form-box clearfix">
            <h3>身上書</h3>
            <x-new-graduate-entry.personal-statement-form />
        </div>

        <div class="form-footer">
            <button type="reset" formaction="{{ route('new-graduate.index') }}" formmethod="GET">
                <span>入力内容をクリア</span>
